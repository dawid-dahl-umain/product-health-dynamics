...
| **Engineering Rigor (ER)** | The degree to which changes apply complexity management principles: modularity, abstraction, separation of concerns, loose coupling, and cohesion. Scale: 0 to 1. All other properties are derived from it. | The agent's skill and discipline. It's the difference between a calculated move and a gamble. |
